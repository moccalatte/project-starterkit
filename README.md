...
Panduan dan template universal untuk membangun proyek berbasis AI (bot, web, atau automation) dengan efisiensi token dan workflow stabil.

---

## 🗺️ Visual Diagram (Placeholder)
...
- [00_context.md](docs/00_context.md) — Deskripsi singkat proyek
- [01_dev_protocol.md](docs/01_dev_protocol.md) — Aturan kolaborasi AI–manusia dan best practice coding
- [02_prd.md](docs/02_prd.md) — Product Requirement Document
- [03_architecture_plan.md](docs/03_architecture_plan.md) — Desain arsitektur & struktur modular
- [04_dev_tasks.md](docs/04_dev_tasks.md) — Daftar tugas development & milestone
- [05_security_policy.md](docs/05_security_policy.md) — Kebijakan keamanan
- [06_risk_audit.md](docs/06_risk_audit.md) — Audit risiko antifraud & mitigasi
- [07_quality_review.md](docs/07_quality_review.md) — Evaluasi kualitas, testing, dan rekomendasi refactor
- [08_release_notes.md](docs/08_release_notes.md) — Catatan rilis versi, perubahan, dan bugfix
- [09_maintenance_plan.md](docs/09_maintenance_plan.md) — Panduan perawatan, backup, dan update
- [agents.md](docs/agents.md) — Definisi peran AI agents
...
| docs/01_dev_protocol.md | Aturan kolaborasi AI–manusia dan best practice coding |
...
| docs/agents.md | Definisi peran AI agents (Builder, Reviewer, Security, Doc, Integration) |
...
3. **Isi deskripsi proyek**
   ...
   * `00_context.md` → isi ringkasan proyek
   * `02_prd.md` → tambahkan user stories & fitur utama

4. **Panggil AI coder (Codex, Jules, Zed, atau lainnya)**
   Jalankan alur prompt di bawah ini untuk memulai build.

---

## 🔁 Alur Prompting Lengkap

Gunakan urutan berikut agar workflow-mu efisien dan tidak boros token.
Kamu cukup mengetikkan prompt ini ke AI coder-mu sesuai tahap.
...
* Gunakan `01_dev_protocol.md` sebagai aturan tetap di semua repositori.

* Setelah build stabil, buat ringkasan `core_summary.md` (1–2 k token) agar cepat direferensi ulang.
  Jika file ini belum ada, kamu bisa membuatnya di folder `docs/` sebagai ringkasan opsional untuk referensi cepat seluruh tim/AI.
...
A: Pastikan AI selalu merujuk ke `01_dev_protocol.md`, `05_security_policy.md`, dan `06_risk_audit.md` sebelum melakukan perubahan besar.

**Q: Apa yang harus dilakukan jika terjadi error atau konflik aturan?**
A: Ikuti protokol debug di `01_dev_protocol.md` dan dokumentasikan semua langkah di folder `/logs/`.

**Q: Apakah saya bisa menambah modul atau agent baru?**
A: Bisa! Cukup tambahkan deskripsi dan aturan baru di file terkait (misal: agents.md atau architecture_plan.md).

**Q: Bagaimana cara rollback jika patch AI gagal?**
A: Ikuti langkah rollback di `04_dev_tasks.md` dan pastikan semua perubahan terdokumentasi di log.
...
Untuk detail, tambahkan file LICENSE di root repo.
...
Toolkit ini cocok dipakai oleh:
